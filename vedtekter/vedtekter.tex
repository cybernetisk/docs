...
\end{enumerate}
\footnotetext{\textit{Etiske retningslinjer for forenings- og styremedlemmer ved Institutt for informatikk} er ikke offisielle retningslinjer fra instituttet, men framarbeidet av frivillige i foreningsmiljøet. Retningslinjene finner man på \href{wikien til foreningen}{https://wiki.cyb.no/display/CYB/Retningslinjer}.}
...
\begin{enumerate}
	...
	\item{Hovedstyret skal strebe mot å opprettholde en minimumsandel på \sfrac{2}{3} studenter som enten er tilknyttet et eller flere studieprogrammer ved Institutt ved informatikk, eller som tar ett eller flere IN- eller INF-fag.\label{itm:minimum}}
