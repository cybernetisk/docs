...
\title{\textbf{Cybernetisk Selskabs vedtekter} \\
	{\large Oppdatert etter ordinær generalforsamling 07.~mai 2025.}}
\date{}
\author{}
...
\newline \href{https://drive.google.com/drive/folders/1LJeCbeFNFhbpIY5TBktoGq2z6aEi48g2?usp=sharing}{Hvis linken ikke funker kan du finne den på driven vår også}}
...
\begin{enumerate}
	...
	\item{\label{item:etterfylling-hs}Hovedstyret kan med \sfrac{3}{4} flertall oppnevne hovedstyremedlemmer ved behov for etterfylling av alle verv foruten leder og kjellermogul. Den etterfylte sitter frem til neste ordinære generalforsamling.} 
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item{Årsregnskap, som skal godkjennes. (Vår)}
		\item{Budsjett, som skal vedtas. (Høst)}
...
\section{Overtredelser, uønsket atferd og sanksjoner}
\begin{enumerate}
    ...
    \item Behandling av overtredelser og varsel, inkludert men ikke begrenset til seksuell trakassering, vold, mobbing, diskriminering, skal gjøres i henhold til \fhref{https://wiki.cyb.no/pages/viewpage.action?pageId=53870838}{foreningens prosedyreregler for håndtering av overtredelser og uønsket atferd}\footnotemark.
    \footnotetext{\textit{\href{https://drive.google.com/file/d/1RdAz51sG5LgoFPjWnIC7ox7tVdjjiwZk/view?usp=drive_link}{Hvis linken ikke funker kan du finne den på driven vår også}}}

    \item Hovedstyret plikter seg til å behandle saker så upartisk som mulig.
    \item Medlemmer kan sanksjoneres ved brudd på medlemsforpliktelsene jf. \ref{item:forpliktelser}. 
    \item Sanksjoner kan inkludere, men er ikke begrenset til, advarsler, midlertidig suspensjon av medlemsrettigheter, eller i alvorlige tilfeller, eksklusjon fra foreningen jf. \ref{sec:eksklusjon}
    \item Sanksjoner skal være proporsjonale med overtredelsens alvorlighetsgrad, og medlemmer som ilegges sanksjoner har rett til å gi en skriftlig uttalelse til Hovedstyret før vedtaket fattes.
    \item Vedtak om sanksjoner kan ankes til generalforsamlingen, som har myndighet til å omgjøre eller opprettholde vedtaket. For omgjøring av et vedtak om sanksjoner kreves det \sfrac{1}{2} flertall.
...
\begin{enumerate}
	...
	\item Medlemmer som foreslås ekskludert for alvorlige brudd på medlemsforpliktelsene jf.~\ref{item:forpliktelser} har rett til å gi en skriftlig uttalelse til Hovedstyret før vedtaket fattes.
\end{enumerate}
