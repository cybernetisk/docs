...
% TODO:
% ENDRE DISSE:
\newcommand{\genforsDato}{15. november  kl. 17:00} % datoen og klokkeslettet genfors faller på
\newcommand{\genforsDag}{onsdag} % dagen genfors faller på ref. mandag, tirsdag osv.
\newcommand{\genforsDatoUkeFoer}{8. november} % 7 dager før \genforDato
...
\newcommand{\nestlederFornavn}{Silje} % fornavn på nestleder
\newcommand{\utsendingFulltNavn}{Silje Helgesen} % fullt navn på den som lager innkallingen (tradisjonelt sett nestleder)
\newcommand{\utsendingVerv}{Nestleder} %vervet til personen som sender ut innkallingen
